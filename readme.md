...
- Elementor Switch Button (Nome do plugin)
- elementor-switch-button (nome dos arquivos, nome do text domain e slug da url do repositório)
- ESB_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- esb_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Elementor Switch Button, através do próprio sistema de atualizações do WordPress
